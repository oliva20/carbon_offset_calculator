...
@Database(entities = {CarEmission.class, BusEmission.class, AirEmission.class, Route.class, Coordinate.class, EmissionTotal.class}, version = 1,exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract EmissionTotalDAO getEmissionTotalDAO();
}
